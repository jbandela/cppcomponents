...
clang++ -std=c++11  -stdlib=$clang_lib ../unit_test_dll.cpp -shared -o unit_test_dll.so -fPIC -fvisibility=hidden
...
clang++ -std=c++11 -D__STRICT_ANSI__ -stdlib=$clang_lib ../unit_test_exe.cpp ./external/googletest-read-only/src/gtest_main.cc ./external/googletest-read-only/src/gtest-all.cc -I ./external/googletest-read-only -I ./external/googletest-read-only/include -o unit_test_exe -ldl -pthread -lsupc++ 
