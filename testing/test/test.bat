...
cl ..\unit_test_exe.cpp ..\unit_test_exe_when_all.cpp ..\unit_test_exe_when_any.cpp  .\external\googletest-read-only\src\gtest_main.cc .\external\googletest-read-only\src\gtest-all.cc /I .\external\googletest-read-only /I .\external\googletest-read-only\include /EHsc /wd4503 /nologo
