...
struct InterfaceDefinition{
    ...
    int test();
    cross_compiler_interface::use_unknown<Interface> GetInterface();
	...
	> uuid;
    CROSS_COMPILER_INTERFACE_CONSTRUCT_UNKNOWN_INTERFACE(InterfaceDefinition,test,GetInterface);
...
struct ImpInterface:public cross_compiler_interface::implement_unknown_interfaces<ImpInterface,InterfaceDefinition::Interface,InterfaceDefinitionNoMembers::Interface>{
    ...
    cross_compiler_interface::use_unknown<InterfaceDefinition::Interface> InterfaceDefinition_GetInterface(){
        return ImpInterface::create().QueryInterface<InterfaceDefinition::Interface>();
    };
    ImpInterface(){
...
BOOST_FIXTURE_TEST_CASE(test_easy_definition1,MyFixture){
    ...
    auto t = ImpInterface::create().QueryInterface<InterfaceDefinition::Interface>();
     ...
     auto info2 = cross_compiler_interface::get_interface_information<InterfaceDefinitionNoMembers::Interface>();

     i = t.test();

     auto p = t.GetInterface();
